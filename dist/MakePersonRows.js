...
function MakePersonRows(persons, deleteButtonHandler, editButtonHandler) {
  var createPersonRow = function createPersonRow(person) {
    if (typeof person.id !== 'number' || person.firstName === '' || person.lastName === '' || typeof person.firstName !== 'string' || typeof person.lastName !== 'string') {
      return /*#__PURE__*/_react.default.createElement(_BrokenRow.default, {
